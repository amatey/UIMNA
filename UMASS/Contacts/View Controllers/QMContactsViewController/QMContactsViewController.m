...
- (void)tableView:(UITableView *)__unused tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UMMessageViewController *detailVC = (UMMessageViewController *)[storyboard instantiateViewControllerWithIdentifier:@"UMMessageViewController"];
    QBChatDialog *privateChatDialog = [[QMCore instance].chatService.dialogsMemoryStorage privateChatDialogWithOpponentID:user.ID];
    detailVC.chatDialog = privateChatDialog;
